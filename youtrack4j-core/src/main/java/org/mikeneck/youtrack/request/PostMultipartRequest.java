...
public abstract class PostMultipartRequest<R> extends PostRequest<R> {

  public PostMultipartRequest(HttpClient client, AccessToken accessToken, PostUrl postUrl) {
